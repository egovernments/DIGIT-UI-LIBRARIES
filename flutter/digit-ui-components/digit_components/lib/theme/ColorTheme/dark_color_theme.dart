...
//
// class DigitDarkColorTheme extends ThemeExtension<DigitDarkColorTheme> {
...
//       covariant ThemeExtension<DigiTDarkColorTheme>? other, double t) {
...
// class Text {
//   const Text({
//     this.primary = const Color(0xFFFBFBFB),
//     this.secondary = const Color(0xFFE2E2E2),
//     this.disabled = const Color(0xFF848484),
//   });
//
//   final Color primary;
...
// class Paper {
//   const Paper({
//     this.primary = const Color(0xFF2D2D2D),
//     this.secondary = const Color(0xFF5C5C5C),
//   });
//
//   final Color primary;
//   final Color secondary;
