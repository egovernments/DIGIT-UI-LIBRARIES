...
class ActionCard extends StatelessWidget {
  ...
  }): assert(actions.length <= 5, 'A maximum of 5 actions are allowed');
      ...
      child: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Column(
                children: actions.asMap()
                    .entries
                    .map((action) {
                  return Padding(
                    padding:  EdgeInsets.only(left: 24, right: 24, top: 24, bottom: action.key==actions.length-1 ? 24 : 0),
                    child: Button(
