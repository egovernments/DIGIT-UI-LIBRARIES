              ...
              suffixIcon: widget.suffixText != null
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: widget.suffixTextStyle ?? currentTypography.headingL.copyWith(
                      color: widget.isDisabled
                          ? const DigitColors()
                          .light
                          .textDisabled
                ...
                child: IntrinsicWidth(
                  child: Center(
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style:
                      widget.suffixTextStyle ?? currentTypography.headingM.copyWith(
                        color: widget.isDisabled
                            ? const DigitColors()
                            .light
                            .textDisabled
              ...
              prefixIcon: widget.prefixText != null
                ...
                child: Container(
                  ...
                  child: Text(
                    widget.prefixText!,
                    textAlign: TextAlign.center,
                    style: widget.prefixTextStyle ?? currentTypography.headingL.copyWith(
                      color: widget.isDisabled
                          ? const DigitColors()
                          .light
                          .textDisabled
                ...
                child: IntrinsicWidth(
                  child: Center(
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style:
                      widget.prefixTextStyle ?? currentTypography.headingM.copyWith(
                        color: widget.isDisabled
                            ? const DigitColors()
                            .light
                            .textDisabled
