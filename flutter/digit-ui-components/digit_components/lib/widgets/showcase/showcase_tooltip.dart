...
class ShowcaseTooltip extends StatefulWidget {
  ...
  final Function()? onNext; // Callback for next action
  final Function()? onClose; // Callback for closing the tooltip
  final Function()? onSkip; // Callback for skipping the showcase
...
class _DigitTooltipState extends State<ShowcaseTooltip>
...
class Bubble extends StatefulWidget {
  ...
  final Function()? onClose;          // Callback for closing the showcase
  final Function()? onNext;           // Callback for moving to the next widget
  final Function()? onSkip;           // Callback for skipping the showcase
                ...
                Row(
                  ...
                  children: [
                    if (widget.onClose != null)
                      DigitButton(label: 'close', onPressed: () => widget.onClose?.call(), type: DigitButtonType.secondary, size: DigitButtonSize.medium),
                    if (widget.onSkip != null)
                      DigitButton(label: 'skip', onPressed: () => widget.onSkip?.call(), type: DigitButtonType.secondary, size: DigitButtonSize.medium),
                    if (widget.onNext != null)
                      DigitButton(label: 'next', onPressed: () => widget.onNext?.call(), type: DigitButtonType.primary, size: DigitButtonSize.medium),
                  ],
                )
              ]
          ),
