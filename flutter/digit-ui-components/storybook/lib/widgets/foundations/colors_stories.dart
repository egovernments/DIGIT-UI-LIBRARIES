          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildCategorySection(context, 'Primary Colors', _buildPrimaryColors(context, colorTheme.primary)),
                _buildCategorySection(context, 'Text Colors', _buildTextColors(context, colorTheme.text)),
                _buildCategorySection(context, 'Paper Colors', _buildPaperColors(context, colorTheme.paper)),
                _buildCategorySection(context, 'Alert Colors', _buildAlertColors(context, colorTheme.alert)),
                _buildCategorySection(context, 'Generic Colors', _buildGenericColors(context, colorTheme.generic)),
              ],
            ),
          ),
        );
