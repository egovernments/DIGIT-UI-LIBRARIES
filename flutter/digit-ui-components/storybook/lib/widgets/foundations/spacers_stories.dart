          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSpacerRow(context, 'Spacer 1', spacerTheme.spacer1),
                _buildSpacerRow(context, 'Spacer 2', spacerTheme.spacer2),
                _buildSpacerRow(context, 'Spacer 3', spacerTheme.spacer3),
                _buildSpacerRow(context, 'Spacer 4', spacerTheme.spacer4),
                _buildSpacerRow(context, 'Spacer 5', spacerTheme.spacer5),
                _buildSpacerRow(context, 'Spacer 6', spacerTheme.spacer6),
                _buildSpacerRow(context, 'Spacer 7', spacerTheme.spacer7),
                _buildSpacerRow(context, 'Spacer 8', spacerTheme.spacer8),
                _buildSpacerRow(context, 'Spacer 9', spacerTheme.spacer9),
                _buildSpacerRow(context, 'Spacer 10', spacerTheme.spacer10),
                _buildSpacerRow(context, 'Spacer 11', spacerTheme.spacer11),
                _buildSpacerRow(context, 'Spacer 12', spacerTheme.spacer12),
              ],
            ),
          ),
        );
