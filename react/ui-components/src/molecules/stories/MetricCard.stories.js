...
Default.args = {
    ...commonArgs,
    metrics:[
        {"value":"3%","description":"Test Compilance","statusmessage":"10% than state average","status":"Decreased"},
        {"value":"60%","description":"Quality Tests Passed","statusmessage":"80% than state average","status":"Increased"},
        {"value":"90%","description":"description","statusmessage":"15% than state average","status":"Nochange"},
        {"value":"26%","description":"description","statusmessage":"6% than state average","status":"Increased"},
    ]
};
