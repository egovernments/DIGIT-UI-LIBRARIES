...
const Table = ({
  ...
  const {
  ...
  } = useTable(
    {
      ...
      pageCount:
        totalRecords > 0 ? Math.ceil(totalRecords / pageSizeLimit) : -1,
  ...
  return (
    ...
    ref={tref}
    style={
      tref.current && tref.current.offsetWidth < tref.current.scrollWidth
        ? { ...inboxStyles }
        : {}
    }
  >
                        ...
                        <span>
                          <span>
                            ...
                            {!manualPagination && pageIndex != 0 && (
                              <ArrowToFirst onClick={() => gotoPage(0)} className={'cp'} />
                            )}
