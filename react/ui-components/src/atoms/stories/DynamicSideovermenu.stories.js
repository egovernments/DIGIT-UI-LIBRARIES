...
export default {
  title: "Atoms/SlideOverMenu/Dynamic",
...
export const RightWithDragging = Template.bind({});
RightWithDragging.args = {
  ...commonArgs,
  type: "dynamic",
  position: "right",
  children: children,
...
export const RightWithCustomWidths = Template.bind({});
RightWithCustomWidths.args = {
  ...commonArgs,
  type: "dynamic",
  position: "right",
  children: children,
...
export const LeftWithSections = Template.bind({});
LeftWithSections.args = {
  ...commonArgs,
  type: "dynamic",
  position: "left",
  header: header,
...
export const LeftWithSectionsAndWithoutBgACtive = Template.bind({});
LeftWithSectionsAndWithoutBgACtive.args = {
  ...commonArgs,
  type: "dynamic",
  position: "left",
  header: header,
...
export const LeftWithDragging = Template.bind({});
LeftWithDragging.args = {
  ...commonArgs,
  type: "dynamic",
  position: "left",
  children: children,
...
export const LeftWithCustomWidths = Template.bind({});
LeftWithCustomWidths.args = {
  ...commonArgs,
  type: "dynamic",
  position: "left",
  children: children,
